...
| Path stones | `x=116 y=456 w=160 h=120` |
| Pawprints | `x=170 y=450 w=120 h=80` |
| Main pedestal | `x=112 y=389 w=170 h=64` |
| Left pedestal | `x=4 y=570 w=166 h=64` |
| Right pedestal | `x=224 y=570 w=166 h=64` |
| 小暴 character | `x=118 y=220 w=170 h=198` |
| 小暴 badge | `x=124 y=404 w=142 h=54` |
| 阿呆 character | `x=-14 y=416 w=186 h=202` |
| 阿呆 badge | `x=20 y=590 w=142 h=54` |
| 咕噜 character | `x=216 y=430 w=174 h=188` |
| 咕噜 badge | `x=228 y=590 w=142 h=54` |
